...
public class ApiKeyFilter implements HttpServerFilter {
    ...
    public Publisher<MutableHttpResponse<?>> doFilter(HttpRequest<?> request, ServerFilterChain chain) {
        ...
        if (path.startsWith("/health") || path.startsWith("/swagger") || path.startsWith("/swagger-ui") || path.startsWith("/openapi") || path.startsWith("/ui") || path.startsWith("/api/auth/token")) {
